...
const MyWork = () => {
    ...
    useEffect(() => {
        ...
        const fetchWorks = async () => {
            ...
            try {
                ...
                setError("আপনার কাজগুলো আনতে ব্যর্থ হয়েছে। সার্ভার সংযোগ বা API এন্ডপয়েন্ট চেক করুন।");
            } finally {
                setLoading(false);
            }
        };
    ...
    const LoadingState = () => (
        <div className="flex justify-center items-center h-64">
            ...
            <p className="ml-4 text-lg font-medium text-indigo-600">কাজ লোড হচ্ছে...</p>
        </div>
    );
    ...
    const EmptyState = () => {
        ...
        return (
            <div className="text-center p-8 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 rounded-lg shadow-md max-w-xl mx-auto">
                ...
                <p className="mt-2">আপনি এখনও কোনো কাজ জমা দেননি, অথবা আপনার ইমেইলটি ({userEmail || 'N/A'}) ডাটাবেসে কোনো কাজ খুঁজে পায়নি।</p>
            </div>
        );
    };
    ...
    const WorkCard = ({ work }) => {
        ...
        const statusColor = work.status === 'pending'
        ...
        return (
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300 border border-gray-200 flex flex-col">
                ...
                <div className="flex justify-between items-start mb-4 border-b pb-3">
                    ...
                    <span className={`px-3 py-1 text-xs font-semibold rounded-full ring-1 ${statusColor}`}>
                        {statusText}
                    </span>
                </div>
                ...
                <div className="space-y-3 text-sm text-gray-600">
                    <div className="flex items-center">
                        ...
                        <span className="ml-2 text-gray-700 font-semibold">{work.workCategory}</span>
                    </div>

                    <div className="flex items-start">
                        <FileText className="w-4 h-4 mt-1 mr-2 text-teal-400 shrink-0" />
                        <span className="font-medium shrink-0">বিবরণ:</span>
                        <p className="ml-2 overflow-auto max-h-20 text-gray-700 bg-gray-50 p-2 rounded-lg border">{work.workDetails}</p>
                    </div>

                    {/* Work Link */}
                    <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2 text-sky-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    return (
        <div className="p-4 sm:p-8 bg-gray-50 min-h-screen font-sans">
            ...
            <p className="text-center text-gray-500 mb-10 text-sm">
                ({userEmail ? `${userEmail}` : 'লগইন প্রয়োজন'} ইমেইল দ্বারা ফিল্টার করা হচ্ছে)
            </p>
