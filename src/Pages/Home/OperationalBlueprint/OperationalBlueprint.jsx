...
const OperationalBlueprint = () => {
    // Duplicate steps for infinite effect
            ...
            <div className="relative w-full overflow-hidden">
                <div className="animate-slide flex w-max gap-6">
                    {extendedSteps.map((step, index) => (
                        <div
                            key={index}
                            className="flex-shrink-0 w-80 bg-white border border-gray-200 rounded-lg p-6 shadow-md"
                        >
                            <div className="bg-blue-600 rounded-full p-5 w-16 h-16 flex items-center justify-center mb-4 shadow">
                                {step.icon}
                            </div>
